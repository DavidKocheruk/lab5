...
MODULE_AUTHOR("David Kocheruk");
MODULE_DESCRIPTION("Hello world Lab-5");
...
static int __init hello_init(void)
{
  ...
  {
    printk(KERN_WARNING "Entered parameter is between 5 and 20");
  } 
  else if(amount > 20)
  {
    printk(KERN_ERR "Entered parameter is bigger than 20");
    return -EINVAL;
  }
